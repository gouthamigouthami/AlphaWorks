...
public:
    ...
    void setupUi(QDialog *Dialog)
    {
        ...
        QObject::connect(btnReject, &QPushButton::clicked, Dialog, qOverload<>(&QDialog::accept));
    ...
    void retranslateUi(QDialog *Dialog)
    {
        ...
        label->setText(QCoreApplication::translate("Dialog", "enter name", nullptr));
